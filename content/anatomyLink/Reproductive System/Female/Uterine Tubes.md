---
tags: [anatomy, reproductive-system, female, duct]
aliases: [fallopian tubes, oviducts, salpinx]
---
...
- Embryological origin: Müllerian (paramesonephric) duct

## 🔬 Parts (Medial → Lateral)

| Part | Description |
|------|-------------|
| **Intramural (interstitial)** | Passes through uterine wall; ~1 cm; narrowest |
| **Isthmus** | Narrow straight segment; ~3 cm |
| **Ampulla** | Widest, longest; ~5 cm; **site of fertilisation** |
| **Infundibulum** | Funnel-shaped; finger-like **fimbriae** sweep oocyte in |

**Histology:** Ciliated columnar epithelium (cilia beat medially) + secretory cells; no muscularis mucosae; peristaltic smooth muscle

## ⚙️ Function
- **Capture** released oocyte via fimbriae (ciliary currents + muscular activity)
- **Fertilisation** occurs in the ampulla (within ~24 h of ovulation)
- **Transport** of zygote to uterus over 3–5 days (cilia + peristalsis)
- Secretes fluid nourishing oocyte/embryo

## 🏥 Clinical Significance
- **Ectopic pregnancy** — commonest site is ampulla (~75%); rupture → haemoperitoneum → haemorrhagic shock; Rx: methotrexate (unruptured) or salpingectomy
- **Salpingitis** — PID complication (*N. gonorrhoeae*, *C. trachomatis*); adhesions → infertility; hydrosalpinx / pyosalpinx
- **Tubal ligation** — sterilisation; most commonly at isthmus
