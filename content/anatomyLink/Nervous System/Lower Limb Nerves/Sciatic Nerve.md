---
tags: [anatomy, nerve, nervous-system, lower-limb, sciatic-nerve]
aliases: [ischiadic nerve]
---
...
- Adductor magnus (posterior/hamstring part) — hip extension
...
- **Sciatica** — pain radiating from the lumbar region/buttock through the posterior thigh to the leg and foot
  - Most common cause: intervertebral disc herniation (L4–S1 levels) compressing nerve roots
  - Dermatomal pattern: L4 (medial leg), L5 (dorsum of foot, first web space), S1 (lateral foot, heel)
...
- **Piriformis syndrome** — sciatic nerve compressed by piriformis muscle (especially with anatomical variant where nerve passes through muscle); buttock pain + sciatica-like symptoms; positive FAIR test (flexion, adduction, internal rotation)
- **Gluteal injection injury** — incorrect technique (medial/inferior injection site); can cause partial or complete sciatic nerve injury; common fibular division typically more affected
- **Popliteal sciatic nerve block** — regional anaesthesia for foot and ankle surgery; performed at the popliteal fossa before bifurcation
...
- [Artificial Knee](https://sketchfab.com/3d-models/artificial-knee-ae66f2927e3347e787455ca60a69338e)