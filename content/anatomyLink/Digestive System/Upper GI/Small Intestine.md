---
tags: [anatomy, small-intestine, digestive-system, upper-gi, midgut]
aliases: [small bowel, duodenum, jejunum, ileum]
---
...
## 🗂️ Specialised Absorptive Mechanisms

| Nutrient | Site | Mechanism |
|---------|------|-----------|
| Carbohydrates | Duodenum/jejunum | Disaccharidases (brush border) → monosaccharides → SGLT1/GLUT5 |
| Proteins | Duodenum/jejunum | Peptidases → amino acids → Na⁺-linked cotransport |
...
- **Duodenal ulcer** — most common peptic ulcer; anterior wall → perforation → peritonitis; posterior wall → bleeds (gastroduodenal artery)
- **Coeliac disease** — autoimmune reaction to gluten → villous atrophy (duodenum/proximal jejunum) → malabsorption; anti-tTG antibodies; treat: gluten-free diet
- **Crohn's disease** — transmural inflammation; any segment but terminal ileum most common; skip lesions; cobblestone mucosa; fistulas; strictures; treat: steroids, biologics, surgery
- **Small bowel obstruction (SBO)** — most common cause: adhesions (post-surgery); also hernias; presents with colicky pain, distension, vomiting, absolute constipation; central dilated loops on AXR
- **Meckel's diverticulum** — persistence of vitello-intestinal duct; 2% population; 2 feet from ileocaecal valve; 2 cm long; ectopic gastric/pancreatic tissue; presents with painless rectal bleeding (children)
