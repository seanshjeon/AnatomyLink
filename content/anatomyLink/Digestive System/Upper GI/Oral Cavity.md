---
tags: [anatomy, oral-cavity, digestive-system, upper-gi, head-neck]
aliases: [mouth, buccal cavity]
---
...
|-----------|-------------|
| **Lips** | Orbicularis oris (CN VII); red zone = vermilion border |
| **Hard palate** | Anterior; bone (maxilla + palatine bones); separates oral from nasal cavity |
| **Soft palate** | Posterior; muscular; uvula at midline; elevates during swallowing to close nasopharynx |
| **Tongue** | Intrinsic + extrinsic muscles (genioglossus — main protrudes; CN XII); taste via CN VII (anterior 2/3), CN IX (posterior 1/3) |
| **Teeth** | 32 permanent; incisors, canines, premolars, molars |
| **Salivary glands** | Parotid (stensen's duct, opposite upper 2nd molar), submandibular (Wharton's duct), sublingual (multiple ducts) |
...
- **Dental caries** — Streptococcus mutans; demineralisation of enamel
- **Parotitis** — parotid gland inflammation; mumps (paramyxovirus) or bacterial (blocked Stensen's duct); parotid swelling anterior to ear
- **Salivary gland calculi (sialolithiasis)** — submandibular most common (alkaline saliva + dependent drainage); pain/swelling at mealtimes
- **Cleft lip / palate** — failure of fusion of facial processes (week 6–7); most common craniofacial abnormality
- **CN XII palsy** — tongue deviates toward the side of the lesion on protrusion
