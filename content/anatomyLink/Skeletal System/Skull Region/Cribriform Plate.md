---
tags: [anatomy, bone, skull, plate, landmark]
aliases: [cribriform plate of ethmoid]
---
...
| Property | Detail |
|----------|--------|
| Bone | Ethmoid (cribriform part) |
| Location | Anterior cranial fossa floor / nasal cavity roof |
| Foramina | Multiple small holes for olfactory nerve filaments |
| Crista galli | Vertical midline projection; dural attachment |

## 🏥 Clinical Significance
- **Anosmia** — Cribriform plate fractures sever olfactory filaments → loss of smell (CN I injury)
- **CSF rhinorrhea** — Cribriform fracture creates pathway for CSF to leak into nasal cavity (halo sign on pillow; β2-transferrin test)
- **Meningitis risk** — CSF leak = open pathway for bacteria from nasal cavity to meninges
