...
aliases: [molar, first molar, second molar, 어금니]
---
...
| Type | Count | Eruption | Roots | Notes |
|------|-------|----------|-------|-------|
...
## 🔑 Key Anatomy
- **Cusps** — Upper: 4–5 cusps; Lower: 5 cusps (lower 1st molar has 5 cusps)
- **Upper molar roots** — 3 roots: mesiobuccal (MB), distobuccal (DB), palatal
  - **MB2 canal** — Additional canal in mesiobuccal root (found in ~70% of upper 1st molars; often missed!)
- **Lower molar roots** — 2 roots: mesial + distal; mesial root often has 2 canals
- **Furcation** — Area between roots; furcation involvement = advanced periodontitis

## 🔑 First Molar — Most Important Tooth
The **upper and lower first molars** are considered the most important teeth for:
- **Occlusal stability** — Foundation of bite
- **Vertical dimension** — Loss → collapsed bite
- **First to decay** — Deep fissures trap bacteria before full eruption

## 🏥 Clinical Significance
- **Caries** — 1st molars most commonly decayed due to deep pit-and-fissure anatomy
- **Sealants** — Applied to prevent pit-and-fissure caries in children
