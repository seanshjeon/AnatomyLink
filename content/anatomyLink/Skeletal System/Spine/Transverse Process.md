...
## 🗂️ Key Facts
| Region | Transverse Process Feature |
|--------|--------------------------|
| Cervical | Has foramen transversarium (vertebral artery C1–C6) |
| Thoracic | Articulates with rib tubercle (costotransverse joint) |
| Lumbar | Broad; L5 largest — iliolumbar ligament attachment |

## 🏥 Clinical Significance
- **Transverse process fracture** — Usually from direct trauma; L1–L3 most common; flank pain; associated with kidney injury
- **Nerve root blocks** — Medial branch nerve blocks placed at transverse process junction
