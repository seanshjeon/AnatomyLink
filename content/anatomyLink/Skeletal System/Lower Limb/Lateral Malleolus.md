...
| Property | Detail |
|----------|--------|
| Level | ~1 cm more distal than medial malleolus |
| Lateral ligaments | ATFL (most commonly injured), CFL, PTFL |
| Syndesmosis | Connected to tibia by anterior/posterior tibiofibular ligaments + interosseous membrane |

## 🏥 Clinical Significance
- **Ankle sprain** — Most common musculoskeletal injury; inversion → ATFL rupture (lateral malleolus origin)
- **Weber classification** — Weber A (below syndesmosis), B (at syndesmosis), C (above syndesmosis = unstable)
- **High ankle sprain (syndesmosis injury)** — Interosseous membrane + tibiofibular ligament torn; worse prognosis than lateral sprain
