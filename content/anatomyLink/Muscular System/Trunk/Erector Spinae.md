---
tags: [anatomy, muscle, muscular-system, trunk, back, erector-spinae]
aliases: [back extensors, paraspinal muscles, sacrospinalis]
---
...
| Muscle | Column | Attachments |
|--------|--------|-------------|
| Spinalis | Medial | Spinous processes |
| Longissimus | Intermediate | Transverse processes + ribs |
| Iliocostalis | Lateral | Ribs + vertebral transverse processes |

Each column has regional subdivisions (lumborum, thoracis, cervicis, capitis).
...
| Insertion | Ribs, transverse/spinous processes, occiput |
| Action | **Bilateral**: spine extension and posture maintenance; **Unilateral**: lateral flexion |
| Innervation | Posterior rami of spinal nerves (segmental) |
| Blood Supply | Posterior intercostal, lumbar, and lateral sacral arteries |

## 🏥 Clinical Significance
- **Low back pain** — Erector spinae strain is the most common musculoskeletal complaint worldwide
- **Paraspinal muscle spasm** — Acute lumbar strain; protective guarding posture
- **Postural dysfunction** — Weakness leads to exaggerated lumbar kyphosis or forward head posture
