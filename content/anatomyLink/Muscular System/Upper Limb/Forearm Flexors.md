...
aliases: [flexor carpi radialis, flexor carpi ulnaris, flexor digitorum superficialis, palmaris longus, wrist flexors]
---
...
|--------|-----------|--------|-------|
| **Flexor Carpi Radialis (FCR)** | Base of 2nd (+ 3rd) metacarpal | Wrist flexion + radial deviation | Median (C6–C7) |
| **Palmaris Longus** | Palmar aponeurosis | Weak wrist flexion; tenses palmar fascia | Median (C7–C8); absent in ~15% |
| **Flexor Carpi Ulnaris (FCU)** | Pisiform → hook of hamate → 5th metacarpal | Wrist flexion + ulnar deviation | **Ulnar nerve (C7–C8)** |
| **Pronator Teres** | Lateral radius (mid-shaft) | Forearm pronation + elbow flexion | Median (C6–C7) |
| **Flexor Digitorum Superficialis (FDS)** | Middle phalanges of fingers 2–5 (splits to allow FDP through) | Flexes PIP joints (and wrist) | Median (C7–T1) |
...
- **Carpal tunnel syndrome** — FDS/FDP tendons + median nerve compressed; wrist flexion (Phalen's) provokes symptoms
- **FCU / pisiform tenderness** — ulnar nerve compression at Guyon's canal (ulnar tunnel)
...
- [Plastinated Forearm](https://sketchfab.com/3d-models/plastinated-forearm-a38f1c7a76d047a2b90b06300cc6ce3e) — UBC.MEDVID
- [Upper Limb with Pronated Forearm](https://sketchfab.com/3d-models/upper-limb-with-pronated-forearm-44306f2deafa40ddbfd7166412df2105) — UBC.MEDVID
- [Upper Limb with Supinated Forearm](https://sketchfab.com/3d-models/upper-limb-with-supinated-forearm-b1acbfa350af4973b037157577dc7972) — UBC.MEDVID
- [Upper Limb Superficial](https://sketchfab.com/3d-models/upper-limb-superficial-117b9253065f460d80365c3195bb9797) — UBC.MEDVID
