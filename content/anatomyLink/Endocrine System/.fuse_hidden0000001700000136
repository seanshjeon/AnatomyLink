...
aliases: [parathyroid, PTH glands, parathyroids]
---
...
|-------|---------------------|-----------------|
| Superior (×2) | 4th pharyngeal pouch | Posterior to upper poles of thyroid at cricothyroid level; more constant |
| Inferior (×2) | 3rd pharyngeal pouch | Posterior to lower thyroid poles; more variable; may be in mediastinum |

- **Chief cells** — produce and secrete PTH
- **Oxyphil cells** — function unclear; increase with age

## ⚙️ PTH Actions (↑ serum Ca²⁺, ↓ serum PO₄³⁻)
| Site | Action |
|------|--------|
| **Bone** | ↑ osteoclast activity → Ca²⁺ + PO₄³⁻ released |
| **Kidney (PCT)** | ↑ Ca²⁺ reabsorption; ↓ PO₄³⁻ reabsorption; ↑ 1α-hydroxylase → ↑ calcitriol (vit D) |
| **Gut (indirect)** | Via ↑ calcitriol → ↑ Ca²⁺ and PO₄³⁻ absorption |
