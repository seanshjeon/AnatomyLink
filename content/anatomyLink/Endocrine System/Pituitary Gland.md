---
tags: [anatomy, endocrine-system, brain, gland]
aliases: [hypophysis, pituitary, master gland]
---
...
Derived from Rathke's pouch (oral ectoderm); produces hormones regulated by hypothalamic releasing/inhibiting factors via portal blood.
...
Derived from brain (diencephalon); **stores and releases** hormones produced in hypothalamus.

| Hormone | Produced in | Effect |
|---------|-------------|--------|
| **ADH (vasopressin)** | Supraoptic nucleus | ↑ water reabsorption in collecting duct; vasoconstriction |
| **Oxytocin** | Paraventricular nucleus | Uterine contraction (labour); milk ejection; social bonding |

## 🏥 Clinical Significance
- **Pituitary adenoma** — most common pituitary tumour; secreting (prolactinoma most common → galactorrhoea, amenorrhoea) vs. non-secreting; mass effect → bitemporal hemianopia
- **Acromegaly** — GH-secreting adenoma in adult; enlarged hands/feet/jaw/tongue; ↑ IGF-1 diagnostic
- **Cushing's disease** — ACTH-secreting adenoma → bilateral adrenal hyperplasia → cortisol excess
- **Diabetes insipidus (cranial)** — ADH deficiency (trauma, surgery, tumour); polyuria + dilute urine; Rx: desmopressin
- **Hypopituitarism** — may follow surgery, radiotherapy, Sheehan's syndrome (post-partum infarction); replace hormones sequentially (cortisol first)
