...
aliases: [pineal body, epiphysis cerebri, conarium]
---
...
## ⚙️ Function
- **Melatonin** — synthesised from serotonin; secreted at night (darkness); suppressed by light
- Entrains circadian rhythm; promotes sleep onset; modulates seasonal reproduction in animals
- Antioxidant properties; potential immune modulation (debated)

## 🏥 Clinical Significance
- **Pineal cyst** — very common incidental finding on MRI; usually benign
- **Pinealoma (germinoma)** — commonest pineal tumour; compresses superior colliculi → **Parinaud's syndrome** (upgaze palsy, convergence-retraction nystagmus, light-near dissociation); CSF obstruction → hydrocephalus
- **Precocious puberty** — pineal tumour may suppress melatonin → early puberty (especially in boys)
- **Jet lag** — disruption of circadian rhythm; exogenous melatonin may help
